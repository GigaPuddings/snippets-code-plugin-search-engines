...
- Version: `1.5.6`
- Source: `docs/plugin-packages/search-engines`
- App compatibility: `>=1.5.6`

Install URL:

```text
https://github.com/GigaPuddings/snippets-code-plugin-search-engines/archive/refs/heads/main.zip
```

Versioned release URL:

```text
https://github.com/GigaPuddings/snippets-code-plugin-search-engines/archive/refs/tags/v1.5.6.zip
```
